...
class ExtractionDatasetMixin:
    def __init__(self) -> None:
        ...
        # (id, start idx of current segment in id_idx) => lenght of current segment
        self.id_idx2len = {}
...
class How2qaExtractDataset(ExtractionDatasetMixin, How2qaDataset):
    def __init__(
            self,
            base_model_name,
            fps,
...
class MsrvttExtractDataset(ExtractionDatasetMixin, MsrvttDataset):
    def __init__(
            self,
            base_model_name,
            fps,
...
class How2qaReuseExtractDataset(ReuseExtractionDatasetMixin, How2qaExtractDataset):
    def __init__(
            self,
            base_model_name,
            fps,
        ...
        assert return_compressed, 'return_compressed must be True for reuse extraction'
        How2qaExtractDataset.__init__(
            self,
            base_model_name,
            fps,
            return_pixel_values=return_pixel_values,
...
class MsrvttReuseExtractDataset(ReuseExtractionDatasetMixin, MsrvttExtractDataset):
    def __init__(
            self,
            base_model_name,
            fps,
