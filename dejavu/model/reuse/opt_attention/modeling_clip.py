...
class CLIPEncoder(nn.Module):
    ...
    def __init__(self, config: CLIPConfig):
        ...
        self.codecnet = codecnet(
            input_shape=[4, 4, token_num_per_side, token_num_per_side],
            # Encoder
    ...
    def forward(
        ...
        **kwargs,
        ...
        # FB, C, T, H, W = compressed.shape
        *_, C, T, CH, CW = compressed.shape

        compressed = compressed.view(-1, C, T, CH, CW)
        compressed_map = self.codecnet(compressed)
        # compressed_map = compressed_map.view(FB, self.num_hidden_layers, -1)
