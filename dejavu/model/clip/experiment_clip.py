...
from transformers.models.clip.modeling_clip import CLIPVisionEmbeddings, CLIPPreTrainedModel
    ...
    def forward(
        ...
        **kwargs,
        ...
        for idx, encoder_layer in enumerate(self.layers):
            ...
            if hidden_caches is None:
                hidden_cache_per_layer = None 
            else:
                hidden_cache_per_layer = hidden_caches[idx]
            layer_outputs = encoder_layer(
                ...
                output_qkvs=output_qkvs,
                output_maps=output_maps,
                hidden_cache=hidden_cache_per_layer,
